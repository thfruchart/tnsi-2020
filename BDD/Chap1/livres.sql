...
ALTER TABLE auteur_de ADD CONSTRAINT fk_isbn FOREIGN KEY (isbn) REFERENCES livre(isbn);
ALTER TABLE auteur_de ADD CONSTRAINT fk_auteur_id FOREIGN KEY (a_id) REFERENCES auteur(a_id);
